...
//SI YA TENEMOS UNA SESIÓN ACTIVA LA CANTIDAD SE VA SUMAR
...
//SI NO TENEMOS UNA SESIÓN ACTIVA LO AÑADIMOS AL ARREGLO NUEVO.
...
<body>
	...
	?>
	<!-- IMPRIMIMOS LOS PRODUCTOS CON LOS DETALLES Y LA PARTE DE ELIMINACIÓN DEL CARRITO-->
				<div class="producto">
					<center>
			...
			<!-- codigo de paypal-->
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post" id="formulario">
					...
					<input type="hidden" name="business" value="osiel781@gmail.com">
